...
## Description
A Twitter Node Module to authenticate and interact with the Twitter REST API from NodeJS. (FavBot)
this bot only fav users if someone mention you on twitter.
